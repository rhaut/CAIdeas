...
public class LeaveSubgroupListener implements Emitter.Listener {
    ...
    private final LeaveSubgroupReceiver resultReceiver;

    public LeaveSubgroupListener(LeaveSubgroupReceiver resultReceiver) {
